...
?>
    ...
    <body>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs mb-3" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#socAgregarTarea" role="tab" aria-selected="false">
                                                        SOC
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#tecnicaAgregarTarea" role="tab" aria-selected="false">
                                                        TECNICA
                                                    </a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#concientizacionAgregarTarea" role="tab" aria-selected="true">
                                                        CONCIENTIZACIÓN
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content  text-muted">
                                                ...
                                                <!-- Inicio carga de tareas SOC -->
                                                <div class="tab-pane active" id="socAgregarTarea" role="tabpanel">
                                                    <div class="row mt-2">
                                                        <div class="col-10 text-center mt-3">
                                                            <div class="container">
                                                                <div id="container-table_soc" class="justify-content-center">
                                                                    
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-2 text-center">
                                                            <button type="button" id="btnAgregarTareaSoc" class="btn btn-success btn-label">Agregar Tarea</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- FIN CARGA TAREAS SOC -->

                                                <!-- <INICIO CARGA TAREAS TECNICA -->
                                                <div class="tab-pane" id="tecnicaAgregarTarea" role="tabpanel">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-2 text-center">
                                                            <button type="button" id="btnAgregarTareaTecnica" class="btn btn-success btn-label">Agregar Tarea</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Fin carga de tareas TECNICA-->

                                                <!-- INICIO CARGA TAREAS CONCIENTIZACION -->
                                                <div class="tab-pane" id="concientizacionAgregarTarea" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-10 mt-3">
                                                            <div class="container">
                                                                <div class="justify-content-center">
                                                        ...
                                                        <div class="col-2 text-center">
                                                            <button type="button" id="btnAgregarTareaConcientizacion" class="btn btn-success btn-label">Agregar Tarea</button>
                                                        </div>
                                                    </div>
                                                </div> 
                                                <!-- FIN CARGA TAREAS CONCIENTIZACION -->

                                               
                                                <?php require_once 'modalCargaTareas.php'; ?>
                                            </div>
                                        </div><!-- end card-body -->
                                    </div><!-- end card -->
                                </div>
        ...
        <script src="administrativa.js"></script>
