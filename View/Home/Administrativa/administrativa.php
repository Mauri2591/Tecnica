                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Administrativa</h4>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs mb-3" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#usuarios" role="tab" aria-selected="false">
                                                        Usuarios
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#licencias" role="tab" aria-selected="false">
                                                        Licencias
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content  text-muted">
                                                <div class="tab-pane active" id="usuarios" role="tabpanel">
                                                    <table class="table table-striped table-hover">
                                                        <caption class="text-center mt-5"><em>Desde aquí puede consultar información de los usuarios</em></caption>
                                                        ...
                                                        <tbody id="table_usuarios_adm" style="font-size: 14px; text-align: center;">

                                                        </tbody>
                                                    </table>
                                                </div>

                                                <div class="tab-pane" id="licencias" role="tabpanel">
                                                    <h6>Licencias</h6>
