                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs mb-3" role="tablist">
                                                <li class="nav-item">
                                                    ...
                                                    <input type="hidden" hidden id="id_sector" value="<?php echo $_SESSION['id_sector']; ?>">
                                                </li>
                                            </ul>
                                            <!-- Tab panes -->
                                            <div id="container-table_tareas_en_curso" class="tab-content  text-muted">
                                                <div class="tab-pane active" id="home" role="tabpanel">
                                                    <h6>Desde aquí puede consultar las tareas nuevas</h6>
                                                    <?php if (isset($_SESSION) && $_SESSION['id_sector'] == 4) { ?>
                                                        <table id="table_tareas_finalizadas" class="mx-auto text-center table align-middle table-nowrap mb-0">
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody id="tbody_total_tareas_finalizadas_x_todos_los_sectores_final">

                                                            </tbody>
                                                        </table>

                                                    <?php } else { ?>
                                                        <table id="table_tareas_en_curso" class="mx-auto text-center table align-middle table-nowrap mb-0">
                                                            <thead>
                                                                <tr style="margin-bottom: 100px;">
                                                                    ...
                                                                    <th style="width: 10px;">Trabajar</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="tbody_total_tareas_activas_soc">
                                                ...
                                                <div class="tab-pane" id="product1" role="tabpanel">
                                                    <div class="row">
                                                        <h5 class="text-center">Desde aquí puede consultar los servicios brindados y agregar nuevos</h5>
                                                        <div class="col-9">
