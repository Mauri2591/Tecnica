                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarDashboards">
                                    <ul class="nav nav-sm flex-column">
                                        <?php
                                        if (isset($_SESSION) && $_SESSION['id_sector'] === 2) {
                                        ?>
                                            <li class="nav-item">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs mb-3" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#servicios_tecnica" role="tab" aria-selected="false">
                                                        Servicios
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content  text-muted">
                                                ...
                                                <div class="tab-pane active" id="home" role="tabpanel">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="justify-content-center">
                                                            <table id="tabla_tareas_finalizadas_tecnica" class="table table-bordered text-center">
                                                                <caption class="text-center">Historial de tareas</caption>
                                                                <thead class="text-center">
                                                                    <tr>
                                                                        <th style="width: 170px;">N° GDE</th>
                                                                        <th style="width: 170px;">N° GDE Cierre</th>
                                                                ...
                                                                <tbody id="tbody_tabla_tareas_finalizadas_tecnica">
                                                ...
                                                <div class="tab-pane" id="servicios_tecnica" role="tabpanel">
                                                    <div class="row">
                                                        <h5 class="text-center">Desde aquí puede consultar los servicios brindados</h5>
                                                        <div class="col-12">
                                                            <div class="justify-content-center">
                                                                <table id="servicios_tecnica" class="table table-bordered text-center">
                                                                    ...
                                                                    <tbody id="tbody_servicios_tecnica">
