                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs mb-3" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#socAgregarTareaManual" role="tab" aria-selected="false">
                                                        Concientizacion
                                                    </a>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="tab-pane active" id="socAgregarTarea" role="tabpanel">
                                                    <div class="row mt-2">
                                                        <div class="col-10 text-center mt-3">
                                                            <div class="container">
                                                                <div id="container-table_soc" class="justify-content-center">
                                                                    <table id="tabla_carga_tareas_soc" class="mx-auto text-center table align-middle table-nowrap mb-0">
                                                                        <thead>
                                                                        ...
                                                                        <tbody id="tbody_total_tareas_vista_carga_soc">
                                                        ...
                                                        <div class="col-2 text-center">
                                                            <button type="button" id="btnAgregarTareaConcientizacionManual" class="btn btn-success btn-label">Agregar Tarea</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- FIN CARGA TAREAS SOC -->

                                                <?php require_once 'modalCargaConcientizacion.php'; ?>
                                            </div>
                                        </div><!-- end card-body -->
                                    </div><!-- end card -->
                                </div>
