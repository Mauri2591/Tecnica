    ...
    <body>
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 m-0">DETALLE DE LOS ACTIVOS POR DEPENDENCIA</h4>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-12">
                                    <div class="card">
                                        <span class="fs-14 mx-3 mt-2 badge bg-primary" id="nom_activo_dependencia"></span>
                                        <button id="boton_agregar_activo" style="width: 100px; margin: 20px 0 10px 10px" type="button" class="btn btn-success btn-sm">Agregar</button>                                        <div class="card-body">
                                            <table id="ver_activos_dependencias">
                                                <thead>
                ...
                <?php require_once 'modalCargaActivo.php'; ?>
                <!-- End Page-content -->
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
        ...
        <script src="verActivos.js"></script>
